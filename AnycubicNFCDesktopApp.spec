...
a = Analysis(
    ...
    hiddenimports = [
        ...
        # PyQt5 modules
        'PyQt5', 'PyQt5.QtCore', 'PyQt5.QtGui', 'PyQt5.QtWidgets', 'PyQt5.QtWebEngineWidgets'
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
exe = EXE(
    ...
    icon='anycubic_nfc_app/static/images/favicon/favicon.ico',  # Set application icon
)
